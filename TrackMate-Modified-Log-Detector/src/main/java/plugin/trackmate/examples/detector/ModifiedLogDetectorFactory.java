...
public class ModifiedLogDetectorFactory< T extends RealType< T > & NativeType< T >> implements SpotDetectorFactory< T >
{
	...
	public static final String DETECTOR_KEY = "Modified_LOG_DETECTOR";

	/** The pretty name of the target detector. */
	public static final String NAME = "Modified LoG detector";
	...
	public SpotDetector< T > getDetector( final Interval interval, final int frame )
	{
		...
		final ModifiedLogDetector< T > detector = new ModifiedLogDetector<>( imFrame, interval, calibration, radius, threshold, doSubpixel, doMedian );
	...
	public SpotDetectorFactoryBase< ? > copy()
	{
		
		return new ModifiedLogDetectorFactory< >();
	}
}
